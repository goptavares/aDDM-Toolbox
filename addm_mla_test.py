...
algorithm (MLA) for the attentional drift-diffusion model (DDM). Artificial
data is generated using specific parameters for the model. These parameters are
then recovered through a maximum likelihood estimation procedure, using a grid
search over the 3 free parameters of the model.
"""
...
from addm_toolbox.addm_mla import aDDM
...
def main():
    ...
    parser.add_argument(u"--d", type=float, default=0.006,
                        help=u"aDDM parameter for generating artificial data.")
    parser.add_argument(u"--sigma", type=float, default=0.08,
                        help=u"aDDM parameter for generating artificial data.")
    parser.add_argument(u"--theta", type=float, default=0.5,
                        help=u"aDDM parameter for generating artificial data.")
